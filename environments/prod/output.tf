...
output "kms_main_key_arn"           { value = module.kms.main_key_arn }
output "rds_endpoint"               { value = module.rds.endpoint;  sensitive = true }
output "rds_address"                { value = module.rds.address;   sensitive = true }
...
output "cloudwatch_log_group_names" { value = module.cloudwatch.log_group_names }
output "rds_master_secret_arn"      { value = module.secrets_manager.rds_master_secret_arn; sensitive = true }