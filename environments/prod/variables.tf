variable "project"                     { type = string; default = "elderping" }
variable "environment"                 { type = string; default = "prod" }
variable "aws_region"                  { type = string; default = "us-east-1" }
variable "owner_email"                 { type = string; default = "ops@elderping.com" }
...
variable "private_app_subnet_a_cidr"   { type = string; default = "10.0.11.0/24" }
variable "private_app_subnet_b_cidr"   { type = string; default = "10.0.12.0/24" }
variable "private_db_subnet_a_cidr"    { type = string; default = "10.0.21.0/24" }
variable "private_db_subnet_b_cidr"    { type = string; default = "10.0.22.0/24" }
...
variable "rds_backup_retention_period" { type = number; default = 7 }
variable "db_username"                 { type = string; sensitive = true }
variable "db_password"                 { type = string; sensitive = true }
variable "jwt_secret"                  { type = string; sensitive = true }
variable "smtp_host"                   { type = string; default = "" }
variable "smtp_port"                   { type = string; default = "587" }
variable "smtp_username"               { type = string; default = ""; sensitive = true }
